...
<h2 align = "center">A modern, cross-platform YouTube video downloader built with Electron, Python/Flask,
yt-dlp, and FFmpeg, featuring a powerful and flexible graphical user interface.</h2>
