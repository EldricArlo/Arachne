...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="YouTube Downloader Backend Server")
    parser.add_argument(
        '--port',
        type=int,
        default=5000,
        help='Port to run the Flask web server on.'
    )
    ...
    logger.info("=" * 50)
    logger.info("YouTube Downloader backend service is starting")
